...
Runtime.DateTime = class extends Runtime.CoreStruct{
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "y")this.__y = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "m")this.__m = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "d")this.__d = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "h")this.__h = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "u")this.__u = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "s")this.__s = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "ms")this.__ms = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "tz")this.__tz = Runtime.rtl.convert(value,"string","UTC","");
